...
const SchedulerDetailPage = ({ params }: PageProps): React.ReactElement => {
    ...
    try {
      if (schedulerData?.Target?.Input) {
        ...
        if (inputData.platform) {
          console.log(
            "[SchedulerDetailPage] Found platform field:",
            inputData.platform
          );
        ...
        console.log(
          "[SchedulerDetailPage] No platform detected, returning N/A"
        );
  ...
  if (schedulerData && extractPlatform(schedulerData) !== "instapaytient") {
    ...
    console.log(
      "[SchedulerDetailPage] Platform not supported:",
      detectedPlatform
    );
        ...
        >
          <CardBody className="text-center p-6">
            ...
            <p className="text-foreground-500 mb-4">
              Other platforms outside of Instapaytient are not supported
            </p>
            <p className="text-tiny text-foreground-400 mt-2">
  ...
  const platformFee: number = calculatePlatformFee(
        ...
        <CardBody className="space-y-6 p-6">
          ...
          <PayoutSummary
            ...
            instantPayoutEnabled={
              account?.payout?.instant_payout_enabled ?? false
            }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <TransactionDetails orderId={order_id} payout={payout} />
          ...
          <Card>
                    ...
                    <TableRow key={item.serviceID}>
                      <TableCell>
                        <div className="flex items-center gap-3">
                          <Avatar radius="sm" size="md" src={item.imageUrl} />
                          <div>
            ...
            <CardFooter className="flex justify-between">
              <div className="flex items-center gap-2">
                <Icon className="text-foreground-500" icon="lucide:user" />
                <span>
