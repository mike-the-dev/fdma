    ...
    return (
      <Card>
        ...
        <CardBody className="text-center p-6">
          <Icon icon="lucide:user-x" width={48} className="text-foreground-500 mx-auto mb-4" />
          <p className="text-foreground-500">Account information not available</p>
        </CardBody>
      </Card>
    );
  }
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <Icon icon="lucide:map-pin" width={16} className="text-foreground-500" />
              <span>{state || "N/A"}</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <Icon icon="lucide:credit-card" width={16} className="text-foreground-500" />
              <span className="font-mono text-sm">{payout?.stripe_id || "N/A"}</span>
            </div>
          </div>
