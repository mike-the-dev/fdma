...
export const AccountReadiness: React.FC<AccountReadinessProps> = ({
  ...
  const affirmEnabled =
    stripeAccount?.capabilities?.affirm_payments === "active";
    ...
    <div className="grid gap-4 md:grid-cols-3 mb-8">
      ...
      <Card className="md:col-span-1">
        <CardBody className="flex flex-col items-center justify-center py-6">
          <div
            className={`flex h-16 w-16 items-center justify-center rounded-full ${affirmEnabled ? "bg-success-100 dark:bg-success-900/30" : "bg-danger-100 dark:bg-danger-900/30"} mb-3`}
          >
            <Icon
              className={`text-3xl ${affirmEnabled ? "text-success-500 dark:text-success-400" : "text-danger-500 dark:text-danger-400"}`}
              icon={
                affirmEnabled ? "lucide:check-circle" : "lucide:alert-circle"
              }
            />
          </div>
      ...
      <Card className="flex-row md:col-span-2">
        <CardBody className="flex flex-col items-center justify-center py-6">
          <div
            className={`flex h-16 w-16 items-center justify-center rounded-full ${allReady ? "bg-success-100 dark:bg-success-900/30" : "bg-danger-100 dark:bg-danger-900/30"} mb-3`}
          >
            <Icon
        ...
        <CardBody className="flex flex-col justify-center px-6">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div
                className={`flex h-6 w-6 items-center justify-center rounded-full ${affirmEnabled ? "bg-success-100 dark:bg-success-900/30" : "bg-danger-100 dark:bg-danger-900/30"}`}
              >
                <Icon
              ...
              <span className="text-gray-700 dark:text-gray-300">
                Affirm capability payments enabled.
              </span>
            </div>

            <div className="flex items-center gap-3">
              <div
                className={`flex h-6 w-6 items-center justify-center rounded-full ${bankAccountLinked ? "bg-success-100 dark:bg-success-900/30" : "bg-danger-100 dark:bg-danger-900/30"}`}
              >
                <Icon
                  className={`text-sm ${bankAccountLinked ? "text-success-500 dark:text-success-400" : "text-danger-500 dark:text-danger-400"}`}
                  icon={
                    bankAccountLinked ? "lucide:check" : "lucide:alert-circle"
                  }
                />
              </div>
              <span className="text-gray-700 dark:text-gray-300">
            ...
            <div className="flex items-center gap-3">
              <div
                className={`flex h-6 w-6 items-center justify-center rounded-full ${stripeLinked ? "bg-success-100 dark:bg-success-900/30" : "bg-danger-100 dark:bg-danger-900/30"}`}
              >
                <Icon
              ...
              <span className="text-gray-700 dark:text-gray-300">
                Stripe linked to Instapaytient.
              </span>
            </div>
          </div>
        </CardBody>
