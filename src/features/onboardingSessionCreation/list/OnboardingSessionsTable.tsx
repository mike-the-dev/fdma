...
import { useOnboardingSessionEmailUpdate } from "./useOnboardingSessionEmailUpdate";
...
const EditDocumentIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
const OnboardingSessionsTable = (): React.ReactElement => {
  ...
  const {
    ...
    handleUpdateEmail,
    isUpdating,
  } = useOnboardingSessionEmailUpdate();
