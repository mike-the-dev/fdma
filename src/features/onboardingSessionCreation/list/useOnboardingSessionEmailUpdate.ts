...
import { validateEmail } from "../_shared/onboardingSessionCreation.validators";
import { useUpdateOnboardingSessionEmail } from "../onboardingSessionCreation.service";

export type OnboardingSessionEmailState = {
  value: string;
  error: string | null;
};

export type UseOnboardingSessionEmailUpdateReturn = {
...
export const useOnboardingSessionEmailUpdate = (): UseOnboardingSessionEmailUpdateReturn => {
  const mutation = useUpdateOnboardingSessionEmail();
  const [emailState, setEmailState] = useState<Record<string, OnboardingSessionEmailState>>({});
