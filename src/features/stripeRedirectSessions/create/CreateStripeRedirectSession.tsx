...
import { useStripeRedirectSessionCreationForm } from "./useStripeRedirectSessionCreationForm";

const CreateStripeRedirectSession = (): React.ReactElement => {
  const {
    form,
    isPending,
    error,
    ...
    session,
    validators,
  } = useStripeRedirectSessionCreationForm();
  ...
  return (
    ...
    >
      <h3>Stripe Redirect Session Creation</h3>
      <p>Create a new Stripe redirect session link for a customer.</p>
      <Spacer y={4} />
      ...
      {session && (
        <>
          ...
          <div className="space-y-3">
            <div>
              <p className="text-sm text-foreground-500">Redirect URL</p>
              <div className="flex items-center gap-2">
                ...
                <Tooltip content="Copy URL">
                  <Button
                    isIconOnly
                    variant="flat"
                    onPress={() => handleCopy(session.redirectUrl)}
                  >
...
export default CreateStripeRedirectSession;
