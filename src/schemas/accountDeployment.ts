...
export const accountDeploymentSchema = z.object({
  ...
  domain: z
    ...
    .refine((val) => {
      ...
      message: "Subdomain cannot start/end with hyphens or have consecutive hyphens"
    })
...
export const validateAccountDeploymentField = (field: keyof AccountDeploymentFormData, value: string) => {
