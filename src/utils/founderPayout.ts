...
const founderPayout = async (
  ...
  payoutMetaData: PayoutMetaData): Promise<void> => {
  ...
  console.log(`Founder payoutAmountAsText from sale of ${currencyFormatter.format(currentSubtotalPrice, { code: 'USD' })}: `, payoutAmountAsText);
