...
const setTotalPayoutAmount = async (payoutUserAccount: PayoutUserAccount, amount: number): Promise<PayoutUserAccount> => {
  const newTotalPayoutAmount: number = amount + payoutUserAccount.totalPayoutAmount;
